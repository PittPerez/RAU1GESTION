...
function ready() {
    ...
    // Cargamos los elementos del carrito desde el localStorage al cargar la página
...
function pagarClicked() {
    ...
    guardarItemsDelCarritoEnLocalStorage();
}
...
function eliminarItemCarrito(event) {
    ...
    // Si no hay, ocultamos el carrito y guardamos los elementos en el localStorage
    ocultarCarrito();
